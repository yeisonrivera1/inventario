...
import 'package:flutter_one/Screens/Aprendiz/solicitar_prestamo/list_detals.dart';
import 'package:flutter_one/Screens/Login/login_screen.dart';
import 'package:flutter_one/components/model_list.dart';


class ListElementsApren extends StatelessWidget {
  @override
        ...
        itemBuilder: (context, index) {
          ...
          return Card(
            child: ListTile(
              ...
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => ModelDetaillsListApren(elements)));
              },
            ),
          );
        },
