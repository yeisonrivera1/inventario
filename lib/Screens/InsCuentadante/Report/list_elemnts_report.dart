...
import 'package:flutter_one/components/model_details_list_Cuen_report.dart';

class ListElemntC extends StatelessWidget {
  @override
            ...
            child: ListTile(
              ...
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => ModelDetaillsListC(datosC)));
              },
            ),
          );
        },
